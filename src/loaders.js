...
const generateSourceMap = options =>
  options.env.OMIT_SOURCEMAP === "true" ? false : true
...
const babelLoader = {
  ...
  options: {
    ...
    cacheDirectory: true,
    cacheCompression: options.env.NODE_ENV === "production",
    compact: options.env.NODE_ENV === "production"
  }
}
...
const client = generateSourceMap => [
  {
    oneOf: [
      babelLoader,
...
const server = generateSourceMap => [
  {
    oneOf: [
      babelLoader,
